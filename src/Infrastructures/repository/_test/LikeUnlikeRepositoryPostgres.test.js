  ...
  describe("behavior test", () => {
    ...
    describe("checkLikeComment function", () => {
      it("should check if comment is liked", async () => {
        ...
        // action
        const isLiked = await likeUnlikeRepositoryPostgres.checkLikeComment(
          payload
        );
    ...
    describe("unlikeComment function", () => {
      it("should unlike comment", async () => {
        ...
        // action
        const isLiked = await likeUnlikeRepositoryPostgres.unlikeComment(
          payload
        );
    ...
    describe("getLikeCountComment function", () => {
      it("should return like count of comment", async () => {
        ...
        // action
        const likeCount =
          await likeUnlikeRepositoryPostgres.getLikeCountComment(
            payload.threadId
          );
